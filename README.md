...
SE-least-squares-analysis/
├─ figures/ # Saved plots generated by main.py
├─ least_squares.py # Normal-equation solver, SVD solver, incremental LS
├─ validation.py # Orthogonality and noise sensitivity validation
├─ make_data.py # Synthetic data generation and real CSV loader
├─ main.py # Runs full experiment suite and generates figures
├─ main_cli.py # Command-line interface for synthetic and real data
